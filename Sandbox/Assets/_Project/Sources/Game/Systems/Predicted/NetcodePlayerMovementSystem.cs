...
namespace _Project.Sources.Game.Systems.Predicted
{
    ...
    public partial struct NetcodePlayerMovementSystem : ISystem
    {
        ...
        {
            foreach ((RefRO<NetcodePlayerInput> netcodePlayerInput, RefRW<LocalTransform> localTransform) in SystemAPI.Query<RefRO<NetcodePlayerInput>, RefRW<LocalTransform>>().WithAll<Player, GhostOwnerIsLocal,Simulate>())
            {
